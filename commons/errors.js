...
exports.admin_restricted_access              = { status: 403, value: 11, message: 'Only administrators can make this request' };
exports.demo_content_request_not_implemented = { status: 403, value: 12, message: 'Demo content on the request not yet implemented' };
exports.not_yours                            = { status: 403, value: 13, message: 'You are not the owner of this resource' };
exports.already_used                         = { status: 403, value: 14, message: 'The resource is already used' };
exports.missing_info                         = { status: 401, value: 15, message: 'Please, provide some info to modify the resource' }; 

...
describe("Access create measurement", () => {
  it("it should create a measurement as admin", async () => {
    ...
    const device = await factory.createDevice("test-device-1", user_admin, [
      feature,
    ]);
  ...
  it("it should create a measurement as provider", async () => {
    ...
    const feature = await factory.createFeature(
      "test-feature-1",
      user_provider
    );
    const device = await factory.createDevice("test-device-1", user_provider, [
      feature,
    ]);
  ...
  it("it should not create a measurement as analyst", async () => {
    ...
    const device = await factory.createDevice("test-device-1", user_analyst, [
      feature,
    ]);
...
describe("Access read a list of measurements", () => {
  it("it should get all the public/private measurements as admin or analyst", async () => {
    const user_admin = await factory.createUser(
      "test-username-user-1",
      "test-password-user-1",
      UserRoles.admin
    );
    const user_analyst = await factory.createUser(
      "test-username-user-2",
      "test-password-user-2",
      UserRoles.analyst
    );
    ...
    const measurement_public_1 = await factory.createMeasurement(
      owner,
      feature,
      device,
      thing_1,
    ...
    const measurement_public_2 = await factory.createMeasurement(
      owner,
      feature,
      device,
      thing_2,
    ...
    const measurement_public_3 = await factory.createMeasurement(
      owner,
      feature,
      device,
      thing_3,
    ...
    const measurement_public_4 = await factory.createMeasurement(
      owner,
      feature,
      device,
      thing_4,
    ...
    const measurement_public_5 = await factory.createMeasurement(
      owner,
      feature,
      device,
      thing_5,
    ...
    const measurement_private_1 = await factory.createMeasurement(
      owner,
      feature,
      device,
      thing_6,
    ...
    const measurement_private_2 = await factory.createMeasurement(
      owner,
      feature,
      device,
      thing_7,
    ...
    const measurement_private_3 = await factory.createMeasurement(
      owner,
      feature,
      device,
      thing_8,
  ...
  it("it should get just his own or public measurements as provider", async () => {
    ...
    const measurement_private_4 = await factory.createMeasurement(
      owner,
      feature,
      device,
      thing_9,
    ...
    const measurement_private_5 = await factory.createMeasurement(
      owner,
      feature,
      device,
      thing_10,
  ...
  it("it should get a filtered list of his own or public measurements as provider", async () => {
    ...
    let res = await chai
      .request(server)
      .keepOpen()
      .get("/v1/measurements?filter=" + filter)
      .set("Authorization", await factory.getUserToken(user_provider));
    res.should.have.status(200);
    res.body.docs.should.be.a("array");
  ...
  it("it should get own or public measurements only of a specific tag AND (of a specific feature OR a specific device)", async () => {
    ...
    let res = await chai
      ...
      .keepOpen()
      .get(
        '/v1/measurements?filter={"$and":[{"tags":"test-tag-1"}, {"$or":[{"feature":"test-feature-1"},{"device":"test-device-1"}]}]}'
      )
      .set("Authorization", await factory.getUserToken(user_admin));
    res.should.have.status(200);
    res.body.docs.should.be.a("array");
  ...
  it("it should get own or public measurements only of a specific tag AND of a specific feature", async () => {
    ...
    let res = await chai
      ...
      .keepOpen()
      .get(
        '/v1/measurements?filter={"tags":"test-tag-1", "feature":"test-feature-1"}'
      )
      .set("Authorization", await factory.getUserToken(user_admin));
    res.should.have.status(200);
    res.body.docs.should.be.a("array");
...
describe("Access read a measurement", () => {
  it("it should get a public/private measurement as admin or analyst", async () => {
    ...
    const thing = await factory.createThing("test-thing-1", owner);
    const measurement_public = await factory.createMeasurement(
      owner,
      feature,
      device,
      thing,
    ...
    const measurement_private = await factory.createMeasurement(
      owner,
      feature,
      device,
      thing,
    ...
    let res = await chai
      .request(server)
      .keepOpen()
      .get("/v1/measurements/" + measurement_public._id)
      .set("Authorization", await factory.getUserToken(user_admin));
    res.should.have.status(200);
    res.body.should.be.a("object");
  ...
  it("it should get a public/private measurement as provider and owner", async () => {
    const user_provider_owner = await factory.createUser(
      "test-username-user",
      "test-password-user",
      UserRoles.provider
    );
    ...
    const thing = await factory.createThing(
      "test-thing-1",
      user_provider_owner
    );
    const measurement_public = await factory.createMeasurement(
    ...
    let res = await chai
      ...
      .keepOpen()
      .get("/v1/measurements/" + measurement_public._id)
      .set("Authorization", await factory.getUserToken(user_provider_owner));
    res.should.have.status(200);
    res.body.should.be.a("object");
    res.body._id.should.eql(measurement_public._id.toString());
    res = await chai
...
describe("Access modify measurement", () => {
  ...
  it("it should modify a measurement as provider and owner", async () => {
    const user_provide_owner = await factory.createUser(
      "test-username-user",
      "test-password-user",
      UserRoles.provider
    );
    ...
    let res = await chai
      ...
      .set("Authorization", await factory.getUserToken(user_provide_owner))
      .send(modification);
    res.should.have.status(200);
    res.body.should.be.a("object");
    res.body.tags.length.should.be.eql(1);
...
describe("Access delete a list of measurements", () => {
  ...
  it("it should delete a filtered list of his own measurements as provider", async () => {
    ...
    let res = await chai
      .request(server)
      .keepOpen()
      .delete("/v1/measurements?filter=" + filter)
      .set("Authorization", await factory.getUserToken(user_provider));
    res.should.have.status(200);
...
describe("Access measurements with right as analyst", () => {
  it("it should get only measurements of features with rights as analyst", async () => {
    ...
    const measurement_noright_1 = await factory.createMeasurement(
      owner,
      feature_noright_1,
      device,
      thing,
  ...
  it("it should get only measurements of device with rights as analyst", async () => {
    ...
    const feature = await factory.createFeature("test-feature-1", owner);
    const device_right_1 = await factory.createDevice("test-device-1", owner, [
      feature,
    ]);
    const device_right_2 = await factory.createDevice("test-device-2", owner, [
      feature,
    ]);
    const device_noright_1 = await factory.createDevice(
      "test-device-3",
      owner,
      [feature]
    );
    const device_noright_2 = await factory.createDevice(
      "test-device-4",
      owner,
      [feature]
    );
    const device_noright_3 = await factory.createDevice(
      "test-device-5",
      owner,
      [feature]
    );
  ...
  it("it should get only measurements of things with rights as analyst", async () => {
    ...
    const thing_right_1 = await factory.createThing(
      "test-thing-1-search",
      owner
    );
    const thing_right_2 = await factory.createThing(
      "test-thing-2-search",
      owner
    );
    const thing_noright_1 = await factory.createThing(
      "test-thing-3-search",
      owner
    );
    const thing_noright_2 = await factory.createThing(
      "test-thing-4-search",
      owner
    );
    const thing_noright_3 = await factory.createThing(
      "test-thing-5-search",
      owner
    );
    const right_1 = await factory.createRight(
    ...
    const measurement_noright_7 = await factory.createMeasurement(
      owner,
      feature,
      device,
      thing_noright_1,
  ...
  it("it should get only measurements of device and feature with rights as analyst", async () => {
    ...
    const right_3 = await factory.createRight(
      "right-test-3",
      device_right_1,
      "Device",
      analyst,
    ...
    const right_4 = await factory.createRight(
      "right-test-4",
      device_right_2,
      "Device",
      analyst,
    ...
    const measurement_noright_5 = await factory.createMeasurement(
      owner,
      feature,
      device_noright_3,
      thing_noright_3,
...
describe("Access measurements withs right as provider", () => {
  it("it should get only his measurements of features with rights as provider", async () => {
    const provider = await factory.createUser(
      "test-username-admin",
      "test-password-admin",
      UserRoles.provider
    );
    ...
    const measurement_right_1_owned = await factory.createMeasurement(
      provider,
      feature_right_1,
      device,
      thing,
    ...
    const measurement_right_2_owned = await factory.createMeasurement(
      provider,
      feature_right_1,
      device,
      thing,
    ...
    const measurement_right_3_owned_but_private = await factory.createMeasurement(
      owner,
      feature_right_2,
      device,
      thing,
    ...
    const measurement_right_4_owned_public = await factory.createMeasurement(
      owner,
      feature_right_2,
      device,
      thing,
    ...
    const measurement_right_5_owned_but_private = await factory.createMeasurement(
      owner,
      feature_right_2,
      device,
      thing,
    ...
    const measurement_right_6_owned_but_private = await factory.createMeasurement(
      owner,
      feature_right_2,
      device,
      thing,
    ...
    const measurement_noright_1_noowne = await factory.createMeasurement(
      owner,
      feature_noright_1,
      device,
      thing,
    ...
    const measurement_noright_2_noown = await factory.createMeasurement(
      owner,
      feature_noright_1,
      device,
      thing,
    ...
    const measurement_noright_3_noown = await factory.createMeasurement(
      owner,
      feature_noright_2,
      device,
      thing,
    ...
    const measurement_noright_4_noown = await factory.createMeasurement(
      owner,
      feature_noright_3,
      device,
      thing,
  ...
  it("it should get only his measurements of features and final with rights as provider (STAGE CHECK)", async () => {
    const provider = await factory.createUser(
      "test-username-admin",
      "test-password-admin",
      UserRoles.provider
  ...
  it("it should get only his measurements of devices with rights as provider", async () => {
    ...
    const measurement_right_3_noown = await factory.createMeasurement(
      owner,
      feature,
      device_right_1,
      thing,
    ...
    const measurement_right_4_noown_public = await factory.createMeasurement(
      owner,
      feature,
      device_right_2,
      thing,
    ...
    const measurement_right_5_noown = await factory.createMeasurement(
      owner,
      feature,
      device_right_1,
      thing,
    ...
    const measurement_right_6_noown = await factory.createMeasurement(
      owner,
      feature,
      device_right_1,
      thing,
    ...
    const measurement_noright_1_noown = await factory.createMeasurement(
      owner,
      feature,
      device_noright_1,
      thing,
  ...
  it("it should get only his measurements of things with rights as provider", async () => {
    ...
    const measurement_right_5_noown_public = await factory.createMeasurement(
      owner,
      feature,
      device,
      thing_right_2,
...
describe("Access a single measurements with rights", () => {
  it("it should access a measurements with rights on thing", async () => {
    ...
    const thing = await factory.createThing("test-thing-1", owner);
    const tag = await factory.createTag("test-tag-1", owner);
    const right = await factory.createRight(
      "right-test-1",
      thing,
      "Thing",
      provider,
  ...
  it("it should not access a measurements with a rights on a different device", async () => {
    ...
    const device_other = await factory.createDevice("test-device-2", owner, [
      feature,
    ]);
    const thing = await factory.createThing("test-thing-1", owner);
    const tag = await factory.createTag("test-tag-1", owner);

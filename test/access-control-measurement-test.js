...
const analyst = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.analyst);
        ...
        const thing = await factory.createThing("test-thing-1-search", owner);
        const right_1 = await factory.createRight("right-test-1", device_right_1, "Device", analyst, owner, []);
        const right_2 = await factory.createRight("right-test-2", device_right_2, "Device", analyst, owner, []);
...
const analyst = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.analyst);
        ...
        const right_1 = await factory.createRight("right-test-1", thing_right_1, "Thing", analyst, owner, []);
        const right_2 = await factory.createRight("right-test-2", thing_right_2, "Thing", analyst, owner, []);
...
const analyst = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.analyst);
        ...
        const right_1 = await factory.createRight("right-test-1", thing_right_1, "Thing", analyst, owner, []);
        const right_2 = await factory.createRight("right-test-2", thing_right_2, "Thing", analyst, owner, []);
        const right_3 = await factory.createRight("right-test-3", device_right_1, "Device", analyst, owner, []);
        const right_4 = await factory.createRight("right-test-4", device_right_2, "Device", analyst, owner, []);
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const device = await factory.createDevice("test-device-1", owner, [feature_right_1, feature_right_2, feature_noright_1, feature_noright_2, feature_noright_3]);
        const thing = await factory.createThing("test-thing-1-search", owner);
        const right_1 = await factory.createRight("right-test-1", feature_right_1, "Feature", provider, owner, []);
        const right_2 = await factory.createRight("right-test-2", feature_right_2, "Feature", provider, owner, []);
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const device_noright_3 = await factory.createDevice("test-device-5", owner, [feature]);
        const thing = await factory.createThing("test-thing-1-search", owner);
        const right_1 = await factory.createRight("right-test-1", device_right_1, "Device", provider, owner, []);
        const right_2 = await factory.createRight("right-test-2", device_right_2, "Device", provider, owner, []);
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const thing_noright_2 = await factory.createThing("test-thing-4-search", owner);
        const thing_noright_3 = await factory.createThing("test-thing-5-search", owner);
        const right_1 = await factory.createRight("right-test-1", thing_right_1, "Thing", provider, owner, []);
        const right_2 = await factory.createRight("right-test-2", thing_right_2, "Thing", provider, owner, []);
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const tag_noright_2 = await factory.createTag("test-tag-4", owner);
        const tag_noright_3 = await factory.createTag("test-tag-5", owner);
        const right_1 = await factory.createRight("right-test-1", tag_right_1, "Tag", provider, owner, []);
        const right_2 = await factory.createRight("right-test-2", tag_right_2, "Tag", provider, owner, []);
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const right_1 = await factory.createRight("right-test-1", thing_right_1, "Thing", provider, owner, []);
        const right_2 = await factory.createRight("right-test-2", thing_right_2, "Thing", provider, owner, []);
        const right_3 = await factory.createRight("right-test-3", tag_right_1, "Tag", provider, owner, []);
        const right_4 = await factory.createRight("right-test-4", tag_right_2, "Tag", provider, owner, []);
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const thing = await factory.createThing("test-thing-1", owner);
        const tag = await factory.createTag("test-tag-1", owner);
        const right = await factory.createRight("right-test-1", thing, "Thing", provider, owner, []);
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const tag = await factory.createTag("test-tag-1", owner);
        const right = await factory.createRight("right-test-1", thing_other, "Thing", provider, owner, []);
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const thing = await factory.createThing("test-thing-1", owner);
        const tag = await factory.createTag("test-tag-1", owner);
        const right = await factory.createRight("right-test-1", device, "Device", provider, owner, []);
        const measurement   = await factory.createMeasurement(provider, feature, device, thing, [tag], factory.createSamples(1), null, null, null, VisibilityTypes.private);
        let res = await chai.request(server).keepOpen().get('/v1/measurements/' + measurement._id).set('Authorization', await factory.getUserToken(provider));
        res.should.have.status(200);
        res.body.should.be.a('object');
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const thing = await factory.createThing("test-thing-1", owner);
        const tag = await factory.createTag("test-tag-1", owner);
        const right = await factory.createRight("right-test-1", device_other, "Device", provider, owner, []);
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const thing = await factory.createThing("test-thing-1", owner);
        const tag = await factory.createTag("test-tag-1", owner);
        const right_1 = await factory.createRight("right-test-1", device, "Device", provider, owner, []);
        const right_2 = await factory.createRight("right-test-2", device_other, "Device", provider, owner, []);
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const tag = await factory.createTag("test-tag-1", owner);
        const right_1 = await factory.createRight("right-test-1", device, "Device", provider, owner, []);
        const right_2 = await factory.createRight("right-test-2", thing_other, "Thing", provider, owner, []);
        const measurement   = await factory.createMeasurement(owner, feature, device, thing, [tag], factory.createSamples(1), null, null, null, VisibilityTypes.public);
        let res = await chai.request(server).keepOpen().get('/v1/measurements/' + measurement._id).set('Authorization', await factory.getUserToken(provider));
        res.should.have.status(errors.restricted_access.status);
        res.body.should.be.a('object');
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const thing = await factory.createThing("test-thing-1", owner);
        const tag = await factory.createTag("test-tag-1", owner);
        const right = await factory.createRight("right-test-1", feature, "Feature", provider, owner, []);
        const measurement   = await factory.createMeasurement(provider, feature, device, thing, [tag], factory.createSamples(1), null, null, null, VisibilityTypes.private);
        let res = await chai.request(server).keepOpen().get('/v1/measurements/' + measurement._id).set('Authorization', await factory.getUserToken(provider));
        res.should.have.status(200);
        res.body.should.be.a('object');
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const thing = await factory.createThing("test-thing-1", owner);
        const tag = await factory.createTag("test-tag-1", owner);
        const right = await factory.createRight("right-test-1", feature_other, "Feature", provider, owner, []);
        const measurement   = await factory.createMeasurement(owner, feature, device, thing, [tag], factory.createSamples(1), null, null, null, VisibilityTypes.public);
        let res = await chai.request(server).keepOpen().get('/v1/measurements/' + measurement._id).set('Authorization', await factory.getUserToken(provider));
        res.should.have.status(errors.restricted_access.status);
        res.body.should.be.a('object');
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const thing = await factory.createThing("test-thing-1", owner);
        const tag = await factory.createTag("test-tag-1", owner);
        const right_1 = await factory.createRight("right-test-1", feature, "Feature", provider, owner, []);
        const right_2 = await factory.createRight("right-test-2", feature_other, "Feature", provider, owner, []);
        const measurement   = await factory.createMeasurement(provider, feature, device, thing, [tag], factory.createSamples(1), null, null, null, VisibilityTypes.private);
        let res = await chai.request(server).keepOpen().get('/v1/measurements/' + measurement._id).set('Authorization', await factory.getUserToken(provider));
        res.should.have.status(200);
        res.body.should.be.a('object');
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const right_1 = await factory.createRight("right-test-1", tag_1, "Tag", provider, owner, []);
        const right_2 = await factory.createRight("right-test-2", tag_2, "Tag", provider, owner, []);
        const right_3 = await factory.createRight("right-test-3", tag_3, "Tag", provider, owner, []);
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const right_2 = await factory.createRight("right-test-2", tag_2, "Tag", provider, owner, []);
        const right_3 = await factory.createRight("right-test-3", tag_3, "Tag", provider, owner, []);
        const right_4 = await factory.createRight("right-test-4", thing_other, "Thing", provider, owner, []);
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const tag = await factory.createTag("test-tag-1", owner);
        const right = await factory.createRight("right-test-1", other_thing, "Thing", provider, owner, []);
...
const provider = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.provider);
        ...
        const thing = await factory.createThing("test-thing-1", owner);
        const tag = await factory.createTag("test-tag-1", owner);
        const right_1 = await factory.createRight("right-test-1", tag, "Tag", provider, owner, []);
        const right_2 = await factory.createRight("right-test-2", device, "Device", provider, owner, []);
        const request = { owner: provider, feature: feature._id, thing: thing._id, device: device._id, tags: [tag._id], samples: [{values: 10.4, delta: 200}] }
        let res = await chai.request(server).keepOpen().post('/v1/measurements/').set('Authorization', await factory.getUserToken(provider)).send(request);
        res.should.have.status(200);
        res.body.should.be.a('object');
...
const analyst = await factory.createUser("test-username-admin", "test-password-admin", UserRoles.analyst);
        ...
        const thing = await factory.createThing("test-thing-1", owner);
        const tag = await factory.createTag("test-tag-1", owner);
        const right = await factory.createRight("right-test-1", feature, "Feature", analyst, owner, []);
        const measurement = await factory.createMeasurement(owner, feature, device, thing, [tag], factory.createSamples(1), null, null, null, VisibilityTypes.public);

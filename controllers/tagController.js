...
exports.get = async (req, res) => { 
    ...
    const restriction_1 = await checker.whatCanOperate(req, res,"Tag");
...
exports.getone = async (req, res) => { 
    ...
    result = await checker.canOperate(req, res,"Tag"); if (result != true) return result;
...
exports.post = async (req, res) => {
    ...
    let result = await checker.canOperate(req, res,"Tag"); if (result != true) return result;
